...
document.getElementById('contactForm').addEventListener('submit', function (event) {
  ...
  if (this.checkValidity()) {
    fetch('/send-email', {
      ...
      .then(data => {
        this.reset();
        showCustomAlert('Your message has been sent. Thank you!');
      })
      .catch(error => {
    ...
    // If form is not valid, show browser's default validation messages
    this.reportValidity();
  }
});
...
function downloadPDF(pdfFileName, pdfName) {
  const pdfUrl = 'img/investor-relations/' + pdfFileName;
